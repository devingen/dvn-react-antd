...
import { ConcealerConditional, ConcealerGenericRuleHandler, Equal } from '../interceptors/ConcealerGenericRule';
...
describe('generateStateOnFieldChange()', () => {
  ...
  it('should contain correct visibilities', function () {
...
describe('generateState()', () => {
  ...
  it('state should contain correct values', function () {
  ...
  it('state should contain correct visibilities', function () {
